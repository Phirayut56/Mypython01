...
print('------------------------------')
number1 = int(input('ป้องตัวเลขตัวที่ 1:'))
number2 = int(input('ป้องตัวเลขตัวที่ 2:'))
number3 = int(input('ป้องตัวเลขตัวที่ 3:'))
number4 = int(input('ป้องตัวเลขตัวที่ 4:'))
number5 = int(input('ป้องตัวเลขตัวที่ 5:'))
print('------------------------------------')
sum_of_5_number = number1 + number2 + number3 + number4 + number5
average_of_5_number = number1 + number2 + number3 + number4 + number5 / 5
print('-------------------------------------------------------------------------------')
print(f'ผลรวม คือ: {sum_of_5_number}')
print(f'ค่าเฉลี่ย คือ: {average_of_5_number}')
print('-------------------------------------------------------------------------------')
